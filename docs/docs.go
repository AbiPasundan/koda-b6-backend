    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AuthForgotPassword"
                        }
                    }
                ],
                "responses": {
        ...
        "/cart": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Delete Cart Item Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.DeleteCartItem"
                        }
                    }
                ],
                "responses": {
